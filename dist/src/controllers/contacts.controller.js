...
exports.getContactController = exports.deleteContactController = exports.updateContactController = exports.createContactController = void 0;
...
const listContacts_services_1 = require("../services/contacts/listContacts.services");
...
const getContactController = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const contactAll = yield (0, listContacts_services_1.listContactsService)(request.user.id);
